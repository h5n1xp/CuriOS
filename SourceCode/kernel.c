...
void kernel_main(multiboot_info_t* mbd, unsigned int magic) {
    ...
    //InitSystemLog(0,0,graphics.frameBuffer.width,graphics.frameBuffer.height);
    ...
    //debug_write_hex(mbd->framebuffer_pitch); debug_write_string(" \nwidth: ");
